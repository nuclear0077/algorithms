...
<details>
<summary>
<b>Генератор скобок (<a href="recursion_sorting/gen_bracket.py">gen_bracket.py</a></b>)
</summary>
...
<details>
<summary>
<b>Комбинации (<a href="recursion_sorting/combinate.py">combinate.py</a></b>)
</summary>
...
<details>
<summary>
<b>Подпоследовательность (<a href="recursion_sorting/subsequence.py">subsequence.py</a></b>)
</summary>
...
<details>
<summary>
<b>Большое число (<a href="recursion_sorting/big_number.py">big_number.py</a></b>)
</summary>
...
<details>
<summary>
<b>Пузырёк (<a href="recursion_sorting/bubble_sort.py">bubble_sort.py</a></b>)
</summary>
...
<details>
<summary>
<b>Два велосипеда (<a href="recursion_sorting/two_bicycle.py">two_bicycle.py</a></b>)
</summary>
...
<details>
<summary>
<b>Клумбы (<a href="recursion_sorting/flowerbed.py">flowerbed.py</a></b>)
</summary>
...
<details>
<summary>
<b>Поиск в сломанном массиве Финальное задание (<a href="recursion_sorting/sprint_13_final/broken_search.py">broken_search.py</a></b>)
</summary>
...
<details>
<summary>
<b>Эффективная быстрая сортировка Финальное задание (<a href="recursion_sorting/sprint_13_final/quick_sort.py">quick_sort.py</a></b>)
</summary>
...
<details>
<summary>
<b>Лампочки (<a href="trees/lamps.py">lamps.py</a></b>)
</summary>
...
<details>
<summary>
<b>Сбалансированное дерево (<a href="trees/balanced.py">balanced.py</a></b>)
</summary>

#### Условие:
[Ссылка](https://contest.yandex.ru/contest/26207/problems/B/)
...
#### Условие:
[Ссылка](https://contest.yandex.ru/contest/26207/problems/E/)
...
<details>
<summary>
<b>Добавь узел (<a href="trees/insert_node.py">insert_node.py</a></b>)
</summary>

#### Условие:
[Ссылка](https://contest.yandex.ru/contest/26207/problems/J/)
...
<details>
<summary>
<b>Выведи диапазон (<a href="trees/output_range.py">output_range.py</a></b>)
</summary>
...
O(h+k), где h –— глубина дерева, k — число элементов в ответе. В данной задаче если в узле содержится ключ x
, то другие ключи, равные x , могут быть как в правом, так и в левом поддереве данного узла. (Дерево строил стажёр, так что ничего страшного).
